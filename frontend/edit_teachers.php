...
<body>
    <div class="container mx-auto p-4 pt-6 mt-10 bg-white rounded-lg shadow-md">
        <h2 class="text-2xl text-emerald-600 mb-4">Edit Teacher</h2>
        <form id="edit-teacher-form">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" class="block w-full p-2 pl-10 text-sm text-gray-700 border border-gray-200 rounded-lg focus:outline-none focus:ring-emerald-600 focus:border-emerald-600">
            </div>
            <div class="mb-4">
            ...
            <button type="submit" class="py-2 px-4 bg-emerald-600 text-white rounded-lg hover:bg-teal-500">Update Teacher</button>
        </form>
    </div>
